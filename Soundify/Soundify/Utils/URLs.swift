...
struct URLs {
    ...
    public static let authorization = APIBaseAuthorizationUrl + "?response_type=token&client_id=" + APIKey.CLIENT_ID + "&scope=" + Constants.encodedScopes + "&redirect_uri=" + Constants.REDIRECT_URI + "&show_dialog=false"
